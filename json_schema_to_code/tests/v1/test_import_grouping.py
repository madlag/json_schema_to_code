...
class TestImportGrouping:
    ...
    def test_python_import_grouping_mixed_modules(self):
        ...
        # Note: List is not imported in modern Python, we use list[...] syntax
    ...
    def test_python_import_deduplication(self):
        ...
        # Should only have one typing import line with Any (List not needed in modern Python)
        typing_imports = [imp for imp in assembled_imports if "from typing import" in imp]
        assert len(typing_imports) == 1
        assert "from typing import Any" in typing_imports[0]
    ...
    def test_import_sorting_within_module(self):
        ...
        generator.register_import_needed(ImportType.LITERAL)  # Should be last
        generator.register_import_needed(ImportType.ANY)  # Should be first
        # Note: LIST and TUPLE don't generate imports in modern Python
        ...
        # Should be alphabetically sorted: Any, Literal
        assert "from typing import Any, Literal" == typing_line
