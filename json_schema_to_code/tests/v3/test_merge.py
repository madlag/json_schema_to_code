...
from json_schema_to_code.pipeline_v3.config import CodeGeneratorConfig, OutputMode
from json_schema_to_code.pipeline_v3.merger import (
    AtomicWriter,
    CodeMergeError,
    PythonAstMerger,
)
...
class TestGeneratorMerge:
    """Tests for PipelineGeneratorV3 merge functionality."""
    ...
    def test_generate_to_file_error_if_exists(self):
        ...
        gen = PipelineGeneratorV3("Test", SIMPLE_SCHEMA, config, "python")
...
class TestCSharpMerger:
    ...
    def test_csharp_merger_requires_tree_sitter(self):
        ...
        try:
            from json_schema_to_code.pipeline_v3.merger import CSharpAstMerger
