...
class TestGenerationComment(TestCase):
    ...
    def test_generation_comment_enabled(self):
        ...
        self.assertTrue(lines[0].startswith("# Generated by json_schema_to_code"),
    ...
    def test_generation_comment_disabled(self):
        ...
        test_case = next(tc for tc in self.test_cases if tc["name"] == "generation_comment_disabled")
        ...
        self.assertFalse(first_non_empty.startswith("#"),
